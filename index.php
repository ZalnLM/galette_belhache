...
require_once __DIR__ . '/app/Core/Uploads.php';
...
$router->get('admin/fixed-fees', [AdminController::class, 'fixedFees']);
$router->post('admin/fixed-fees', [AdminController::class, 'storeFixedFee']);
$router->post('admin/fixed-fees/{id}/update', [AdminController::class, 'updateFixedFee']);
$router->post('admin/fixed-fees/{id}/delete', [AdminController::class, 'deleteFixedFee']);
$router->get('admin/homepage', [AdminController::class, 'homepage']);
$router->post('admin/homepage', [AdminController::class, 'updateHomepage']);
